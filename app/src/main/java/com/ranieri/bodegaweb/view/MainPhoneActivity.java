...
public class MainPhoneActivity extends MainGenericActivity implements ClickOnProviderListener, ClickOnOrderListener {
    ...
    public void subCategoryClicked(SubCategorias subCategoria) {
        Log.v("MainPhoneActivity", "subCategoryClicked");
    ...
    public void orderClicked(Order order) {
        Log.v("MainPhoneActivity", "orderClicked");
    ...
    public void providerClicked(Provider provider) {
        Log.v("MainPhoneActivity", "providerClicked");
